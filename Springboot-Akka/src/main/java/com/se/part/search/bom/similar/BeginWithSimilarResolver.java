...
@Service("9")
public class BeginWithSimilarResolver implements SimilarPartsResolver
{
	@Autowired
	Util<BOMRow> util;
	@Autowired
	...
	public List<BOMRow> similarParts(String partNumber, String manId)
	{
		...
		String query = util.getPartManQuery(partNumber, manId, qb, false, false, ConstantSolrFields.NAN_PARTNUM_EXACT);
		...
		try
		{
			...
			{
				query = util.getPartManQuery(partNumber, manId, qb, true, false, ConstantSolrFields.NAN_PARTNUM_EXACT);
